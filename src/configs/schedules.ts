// Fixed round-robin schedules: 8 rounds à 6 courts, "A1" = team 1 of group A.
// Courts 1-3 (index 0-2) play sitting, courts 4-6 standing (see COURT_IS_SITTING).
export const VORRUNDE_SCHEDULE = [
...
export const FINALRUNDE_SCHEDULE = [
  ...
  ['G1-G4', 'H3-H4', 'E2-E4', 'E1-E3', 'F1-F2', 'G2-G3'],
